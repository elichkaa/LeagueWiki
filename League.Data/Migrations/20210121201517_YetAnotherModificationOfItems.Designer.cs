...
namespace League.Data.Migrations
{
    ...
    [Migration("20210121201517_YetAnotherModificationOfItems")]
    partial class YetAnotherModificationOfItems
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("League.Models.ItemData.ItemStats", b =>
                {
                    ...
                    b.Property<double?>("FlatCritChanceMod")
                        .HasColumnType("float");

                    b.Property<int?>("FlatHPPoolMod")
                        .HasColumnType("int");

                    b.Property<double?>("FlatHPRegenMod")
                        .HasColumnType("float");

                    b.Property<int?>("FlatMPPoolMod")
                        .HasColumnType("int");

                    b.Property<int?>("FlatMagicDamageMod")
                        .HasColumnType("int");

                    b.Property<int?>("FlatMovementSpeedMod")
                        .HasColumnType("int");

                    b.Property<int?>("FlatPhysicalDamageMod")
                        .HasColumnType("int");
                    ...
                    b.Property<double?>("PercentLifeStealMod")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("League.Models.ItemData.Relationships.ItemFrom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("League.Models.ItemData.Relationships.ItemTo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("League.Models.ItemData.Item", b =>
                {
                    ...
                    b.HasOne("League.Models.ItemData.ItemStats", "ItemStats")
                        .WithMany()
                        .HasForeignKey("ItemStatsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("League.Models.ItemData.Relationships.ItemsFrom", "ItemsFrom")
                        .WithMany("Items")
                        .HasForeignKey("ItemsFromId");

                    b.HasOne("League.Models.ItemData.ItemsTo", "ItemsTo")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("League.Models.ItemData.Relationships.ItemItemsFrom", b =>
                {
                    b.HasOne("League.Models.ItemData.Relationships.ItemFrom", "ItemFrom")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("League.Models.ItemData.Relationships.ItemItemsTo", b =>
                {
                    ...
                    b.HasOne("League.Models.ItemData.Relationships.ItemTo", "ItemTo")
                        .WithMany("Items")
