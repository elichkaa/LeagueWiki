...
namespace League.Data.Migrations
{
    ...
    [Migration("20210131064338_AddRecommended")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("League.Models.ChampionData.AllyTip", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("League.Models.ChampionData.BlockItem", b =>
                {
            ...
            modelBuilder.Entity("League.Models.ChampionData.EnemyTip", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("League.Models.ChampionData.Passive", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("League.Models.ChampionData.BlockItem", b =>
                {
                    b.HasOne("League.Models.ChampionData.Block", "Block")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("League.Models.ChampionData.Champion", b =>
                {
                    ...
                    b.HasOne("League.Models.ChampionData.Passive", "Passive")
                        .WithMany()
            ...
            modelBuilder.Entity("League.Models.Image", b =>
                {
                    b.HasOne("League.Models.ChampionData.Skin", null)
                        .WithMany("Images")
